...
// CWTag
#define COCOAPODS_POD_AVAILABLE_CWTag
#define COCOAPODS_VERSION_MAJOR_CWTag 0
#define COCOAPODS_VERSION_MINOR_CWTag 1
#define COCOAPODS_VERSION_PATCH_CWTag 0
